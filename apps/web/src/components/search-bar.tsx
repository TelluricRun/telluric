...
export default function SearchBar() {
  ...
  return (
    <div style={{ 
      ...
      backgroundColor: '#fff', 
      padding: '50px 0',
	  borderTop: '1px solid var(--glacier-dark)',
    }}>
      <div style={{ 
        width: '100%', 
        maxWidth: '1370px', 
        ...
        backgroundColor: '#fff',
        borderRadius: '34px',
		border: '1px solid var(--glacier-dark)',
        // boxShadow: '0 2px 8px rgba(0, 0, 0, 0.05), 0 4px 16px rgba(0, 0, 0, 0.025)',
        display: 'flex',
        alignItems: 'center',
        gap: '12px'
      }}>
        ...
        <div style={{ 
          ...
          <IconSearch size='20px' color='#000000' />
        </div>
